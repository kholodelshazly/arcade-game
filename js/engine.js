...
var Engine = (function(global) {
    ...
    function render() {
        ...
        for (row = 0; row < numRows; row++) {
            for (col = 0; col < numCols; col++) {
                 ...
                 */
                ctx.drawImage(Resources.get(rowImages[row]), col * T_WIDTH, row * T_HEIGHT);
            }
        }
        ...
        this.ctx.fillText(scoreText, (CANVAS_WIDTH - this.ctx.measureText(scoreText).width)/2,30);
        ...
        if(isGameOver){
            ...
            if(winGame){
                gameOverTextLine1 = "You Won!";
            }
            var metrics1 = this.ctx.measureText(gameOverTextLine1);
            var tX1 = (CANVAS_WIDTH - metrics1.width)/2;
            var tY1 = (CANVAS_HEIGHT)/2;
            this.ctx.fillText(gameOverTextLine1, tX1, tY1);
    ...
    function renderCharactersWhenSelecting(){
        for(var i = 0; i < charactersNameList.length; i++){
            this.ctx.drawImage(Resources.get('images/' + charactersNameList[i] + '.png'), i * T_WIDTH + T_WIDTH , 5 * T_HEIGHT);
        }
    }
